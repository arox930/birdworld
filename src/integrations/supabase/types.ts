  ...
  public: {
    Tables: {
      ...
      dogs: {
        ...
        Relationships: [
          {
            foreignKeyName: "dogs_comprador_id_fkey"
            columns: ["comprador_id"]
            isOneToOne: false
            referencedRelation: "buyers"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "dogs_madre_id_fkey"
            columns: ["madre_id"]
            isOneToOne: false
      ...
      litters: {
        Row: {
          ...
          id: string
          machos: number
          mother_dog_id: string
          muertos_parto: number
          nacidos_total: number
          notas: string | null
        }
        Insert: {
          created_at?: string
        ...
        Relationships: [
          {
            foreignKeyName: "litters_mother_dog_id_fkey"
            columns: ["mother_dog_id"]
            isOneToOne: false
            referencedRelation: "dogs"
            referencedColumns: ["id"]
          },
      ...
      vaccination_reminders: {
        ...
        Relationships: [
          {
            foreignKeyName: "vaccination_reminders_dog_id_fkey"
            columns: ["dog_id"]
            isOneToOne: false
            referencedRelation: "dogs"
            referencedColumns: ["id"]
